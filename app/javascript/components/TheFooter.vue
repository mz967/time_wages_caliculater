<template>
  ...
  <footer class="text-white bg-gradient-to-b hover:bg-gradient-to-t from-blue-400 via-blue-500 to-blue-600">
    <div class="container px-5 py-6 ml-auto flex items-center sm:flex-row flex-col">
      <div class="md:ml-auto md:mr-4 md:py-1 md:pl-4 flex flex-wrap mt-10 justify-center">
