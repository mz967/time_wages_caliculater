        ...
        <ValidationObserver v-slot="{ handleSubmit }">
          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 text-center">
            <div class="mt-12 mb-4">
              ...
              >
                <label
                  class="block mb-10 md:text-xl text-4xl font-bold"
                  for="title"
                >
          ...
          <div class="px-4 py-3 text-center">
            <button
              type="button"
              class="xl:w-48 w-56 inline-flex justify-center rounded-md border border-transparent shadow px-4 py-2 bg-gradient-to-b hover:bg-gradient-to-t from-blue-400 via-blue-500 to-blue-400 text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 md:text-sm text-4xl mb-10"
