<template>
  <section class="text-gray-600 body-font">
    <div class="container px-5 py-24 mx-auto">
      ...
      <router-link :to="{ name: 'RegisterNew' }"  class="mx-auto mt-20 text-white bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg w-64">ユーザー登録をする</router-link>
      </div> -->
    </div>
  </section>
</template>
